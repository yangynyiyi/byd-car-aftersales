package com.byd.aftersales.client;
...
public class AiAgentClient {
    ...
    @Value("${ai.agent.base-url:https://dashscope.aliyuncs.com/compatible-mode/v1}")
    private String baseUrl;

    @Value("${ai.agent.model:qwen-plus}")
    ...
    public String call(String systemPrompt, String userMessage) {
        if (!isConfigured()) {
            throw new IllegalStateException("未配置 ai.agent.api-key");
        }
        ...
        try {
            ...
            throw new RuntimeException("AI Agent 调用失败，请稍后重试: " + e.getMessage(), e);
        }
    }
}
